...
To install Actinvoting, run this command in your terminal:

.. code-block:: console

    $ pip install actinvoting

This is the preferred method to install Actinvoting, as it will always install the most recent stable release.
...
The sources for Actinvoting can be downloaded from the `Github repo`_.
